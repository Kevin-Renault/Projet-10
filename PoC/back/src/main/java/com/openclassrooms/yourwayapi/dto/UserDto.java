package com.openclassrooms.yourwayapi.dto;
...
public record UserDto(
                ...
                @Schema(description = "Username", example = "john_doe") @Size(max = 100) String username,
                ...
                @Schema(description = "Role", example = "client", allowableValues = {
                                "client", "agent" }) @Size(max = 30) String role,
