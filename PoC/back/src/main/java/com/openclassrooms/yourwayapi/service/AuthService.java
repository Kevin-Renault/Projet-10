...
import com.openclassrooms.yourwayapi.security.JwtService;
...
public class AuthService {
    ...
    public AuthService(YourWayUserRepository userRepository, PasswordEncoder passwordEncoder, JwtService jwtService) {
    ...
    public AuthResponseDto register(RegisterRequest request) {
        ...
        YourWayUserEntity user = new YourWayUserEntity();
    ...
    public AuthResponseDto login(LoginRequest request) {
        ...
        YourWayUserEntity user = userRepository.findByEmail(request.email())
    ...
    public UserDto toUserDto(YourWayUserEntity user) {
        return new UserDto(
                user.getId(),
                user.getUsername(),
                user.getEmail(),
