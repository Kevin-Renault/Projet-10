...
public class YourWayUserController {

    private final YourWayUserService userService;

    public YourWayUserController(YourWayUserService userService) {
    ...
    public UserDto updateCurrent(
            @Parameter(hidden = true) @AuthenticationPrincipal YourWayUserEntity principal,
